...
manifest = {
    "schema": "bio-001-s36-source-manifest-v1",
    "target": {
        "filename": FILENAME,
        "url": URL,
    ...
    "development_url_present": False,
    "sealed_holdout_url_present": False,
}
nonaccess = {
    "schema": "bio-001-s36-holdout-nonaccess-v1",
...
(root / "holdout_nonaccess_receipt.json").write_text(json.dumps(nonaccess, indent=2, sort_keys=True))
